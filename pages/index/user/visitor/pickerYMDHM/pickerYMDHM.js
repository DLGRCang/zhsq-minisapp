Component({
  ...
  methods: {
    _onInit() {
      ...
      //  let monthTime;
      //  if(this.data.date.split(" ")[0].split("-")[1].split("")[0] == "0"){
      //   monthTime = this.data.date.split(" ")[0].split("-")[1].split("")[1]
      //  }else{
      //   monthTime = this.data.date.split(" ")[0].split("-")[1]
      //  }
      let month = [];
      for (let i = 1; i <= 12; i++) {
      ...
      // let dayTime;
      //  if(this.data.date.split(" ")[0].split("-")[2].split("")[0] == "0"){
